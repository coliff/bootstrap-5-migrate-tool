...
function migrate() {
  ...
  return (
    src(['src/*.{html,htm,php}'])
      ...
      .pipe(
        replace(/\sdata-animation=/g, function () {
          dataAttrChanged++;
          return ' data-bs-animation=';
        }),
      )
      .pipe(
        replace(/\sdata-autohide=/g, function () {
          dataAttrChanged++;
          return ' data-bs-autohide=';
        }),
      )
      .pipe(
        replace(/\sdata-boundary=/g, function () {
          dataAttrChanged++;
          return ' data-bs-boundary=';
        }),
      )
      .pipe(
        replace(/\sdata-container=/g, function () {
          dataAttrChanged++;
          return ' data-bs-container=';
        }),
      )
      .pipe(
        replace(/\sdata-content=/g, function () {
          dataAttrChanged++;
          return ' data-bs-content=';
        }),
      )
      .pipe(
        replace(/\sdata-custom-class=/g, function () {
          dataAttrChanged++;
          return ' data-bs-custom-class=';
        }),
      )
      .pipe(
        replace(/\sdata-delay=/g, function () {
          dataAttrChanged++;
          return ' data-bs-delay=';
        }),
      )
      .pipe(
        replace(/\sdata-dismiss=/g, function () {
          dataAttrChanged++;
          return ' data-bs-dismiss=';
        }),
      )
      .pipe(
        replace(/\sdata-display=/g, function () {
          dataAttrChanged++;
          return ' data-bs-display=';
        }),
      )
      .pipe(
        replace(/\sdata-html=/g, function () {
          dataAttrChanged++;
          return ' data-bs-html=';
        }),
      )
      .pipe(
        replace(/\sdata-interval=/g, function () {
          dataAttrChanged++;
          return ' data-bs-interval=';
        }),
      )
      .pipe(
        replace(/\sdata-keyboard=/g, function () {
          dataAttrChanged++;
          return ' data-bs-keyboard=';
        }),
      )
      .pipe(
        replace(/\sdata-method=/g, function () {
          dataAttrChanged++;
          return ' data-bs-method=';
        }),
      )
      .pipe(
        replace(/\sdata-offset=/g, function () {
          dataAttrChanged++;
          return ' data-bs-offset=';
        }),
      )
      .pipe(
        replace(/\sdata-pause=/g, function () {
          dataAttrChanged++;
          return ' data-bs-pause=';
        }),
      )
      .pipe(
        replace(/\sdata-placement=/g, function () {
          dataAttrChanged++;
          return ' data-bs-placement=';
        }),
      )
      .pipe(
        replace(/\sdata-popper-config=/g, function () {
          dataAttrChanged++;
          return ' data-bs-popper-config=';
        }),
      )
      .pipe(
        replace(/\sdata-reference=/g, function () {
          dataAttrChanged++;
          return ' data-bs-reference=';
        }),
      )
      .pipe(
        replace(/\sdata-ride=/g, function () {
          dataAttrChanged++;
          return ' data-bs-ride=';
        }),
      )
      .pipe(
        replace(/\sdata-selector=/g, function () {
          dataAttrChanged++;
          return ' data-bs-selector=';
        }),
      )
      .pipe(
        replace(/\sdata-slide=/g, function () {
          dataAttrChanged++;
          return ' data-bs-slide=';
        }),
      )
      .pipe(
        replace(/\sdata-slide-to=/g, function () {
          dataAttrChanged++;
          return ' data-bs-slide-to=';
        }),
      )
      .pipe(
        replace(/\sdata-target=/g, function () {
          dataAttrChanged++;
          return ' data-bs-target=';
        }),
      )
      .pipe(
        replace(/\sdata-template=/g, function () {
          dataAttrChanged++;
          return ' data-bs-template=';
        }),
      )
      .pipe(
        replace(/\sdata-title=/g, function () {
          dataAttrChanged++;
          return ' data-bs-title=';
        }),
      )
      .pipe(
        replace(/\sdata-toggle=/g, function () {
          dataAttrChanged++;
          return ' data-bs-toggle=';
        }),
      )
      .pipe(
        replace(/\sdata-touch=/g, function () {
          dataAttrChanged++;
          return ' data-bs-touch=';
        }),
      )
      .pipe(
        replace(/\sdata-trigger=/g, function () {
          dataAttrChanged++;
          return ' data-bs-trigger=';
        }),
      )
      .pipe(
        replace(/\sdata-wrap=/g, function () {
          dataAttrChanged++;
          return ' data-bs-wrap=';
        }),
      )
