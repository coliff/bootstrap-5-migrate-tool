    ...
    src([`${options.src}/${options.defaultFileGlob}`], { base: options.overwrite ? './' : undefined })
      ...
      .pipe(
        replace(
          ...
          function () {
            CDNLinksChanged++;
            return '<link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.4/css/bootstrap.min.css" rel="stylesheet">';
          }
        )
      )
      // JSDelivr CSS
      .pipe(
        replace(/<link href=["']https:\/\/cdn\.jsdelivr\.net\/npm\/bootstrap@4\.\d+\.\d+\/dist\/css\/bootstrap(\.min)?\.css["'] rel=["']stylesheet["'] ?\/?>/g, function () {
          CDNLinksChanged++;
          return '<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.4/dist/css/bootstrap.min.css" rel="stylesheet">';
        })
      )
      // Stackpath CSS
      .pipe(
        replace(/<link href=["']https:\/\/stackpath\.bootstrapcdn\.com\/bootstrap\/4\.\d+\.\d+\/css\/bootstrap(\.min)?\.css["'] rel=["']stylesheet["'] ?\/?>/g, function () {
          CDNLinksChanged++;
          return '<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.4/dist/css/bootstrap.min.css">';
        })
      )
      // UNPKG CSS
      .pipe(
        replace(/<link href=["']https:\/\/unpkg\.com\/bootstrap\/4\.\d+\.\d+\/css\/bootstrap(\.min)?\.css["'] rel=["']stylesheet["'] ?\/?>/g, function () {
          CDNLinksChanged++;
          return '<link href="https://unpkg.com/bootstrap@5.3.4/dist/css/bootstrap.min.css">';
        })
      )
      // CDNJS JS
      .pipe(
        replace(/<script src=["']https:\/\/cdn\.cloudflare\.com\/ajax\/libs\/bootstrap\/4\.\d+\.\d+\/dist\/js\/bootstrap(\.min)?\.js["']>/g, function () {
          CDNLinksChanged++;
          return '<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.4/js/bootstrap.min.js">';
        })
      )
      // JSDelivr JS
      .pipe(
        replace(/<script src=["']https:\/\/cdn\.jsdelivr\.net\/npm\/bootstrap@4\.\d+\.\d+\/dist\/js\/bootstrap(\.min)?\.js["']>/g, function () {
          CDNLinksChanged++;
          return '<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.4/dist/js/bootstrap.min.js">';
        })
      )
      // Stackpath JS
      .pipe(
      ...
      .pipe(
        replace(/<script src=["']https:\/\/unpkg\.com\/bootstrap\/4\.\d+\.\d+\/js\/bootstrap(\.min)?\.js["']>/g, function () {
          CDNLinksChanged++;
          return '<script src="https://unpkg.com/bootstrap@5.3.4/dist/js/bootstrap.min.js">';
        })
      )
      // CDNJS Bundle JS
      .pipe(
        replace(/<script src=["']https:\/\/cdn\.cloudflare\.com\/ajax\/libs\/bootstrap\/4\.\d+\.\d+\/dist\/js\/bootstrap\.bundle(\.min)?\.js["']>/g, function () {
          CDNLinksChanged++;
          return '<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.4/js/bootstrap.bundle.min.js">';
        })
      )
      // JSDelivr Bundle JS
      .pipe(
        replace(/<script src=["']https:\/\/cdn\.jsdelivr\.net\/npm\/bootstrap@4\.\d+\.\d+\/dist\/js\/bootstrap\.bundle(\.min)?\.js["']>/g, function () {
          CDNLinksChanged++;
          return '<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.4/dist/js/bootstrap.bundle.min.js">';
        })
      )
      // Stackpath Bundle JS
      .pipe(
      ...
      .pipe(
        replace(/<script src=["']https:\/\/unpkg\.com\/bootstrap\/4\.\d+\.\d+\/js\/bootstrap\.bundle(\.min)?\.js["']>/g, function () {
          CDNLinksChanged++;
          return '<script src="https://unpkg.com/bootstrap@5.3.4/dist/js/bootstrap.bundle.min.js">';
        })
      )
      .pipe(
        replace(
